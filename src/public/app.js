window.onload = function() {
    ...
    analyzeButton.addEventListener('click', async function() {
        ...
        const prompt = `Please provide a creative analysis of the following dream: '${dreamDescription}'. Focus on symbolic meanings, emotions involved, and possible interpretations.`;
